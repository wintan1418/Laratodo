                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <p class="text-sm text-yellow-800 dark:text-yellow-200">
                                <strong>Weather unavailable:</strong> Please check your OpenWeatherMap API key in <code>.env</code> file. 
                                <a href="https://openweathermap.org/api" target="_blank" class="underline">Get a free API key here</a>
                            </p>
                        </div>
                    </div>
                </div>
